...
if st.sidebar.button("Send Transaction"):
    ...
    # It was difficult to read the transaction hash, so printed the whole block to verify the transaction
    st.sidebar.write(w3.eth.get_transaction(transaction_hash))
